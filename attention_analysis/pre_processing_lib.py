...
class Instance:
    ...
    def get_dependency_path(self) -> List:
        return self._dependency_path

    def set_dependency_path(self, dependency_path: List):
        self._dependency_path = dependency_path

    def set_breadth_first(self, breadth_first: List):
        self._breadth_first = breadth_first

    def set_depth_first(self, depth_first: List):
        self._depth_first = depth_first

    def get_depth_first(self) -> List:
        return self._depth_first

    def get_breadth_first(self) -> List:
